...
/* Private defines -----------------------------------------------------------*/
#define DRV_PMODE_Pin GPIO_PIN_5
#define DRV_PMODE_GPIO_Port GPIOA
#define DRV_SLEEP_Pin GPIO_PIN_6
#define DRV_SLEEP_GPIO_Port GPIOA
#define DRV_IN1_Pin GPIO_PIN_7
#define DRV_IN1_GPIO_Port GPIOA
#define DRV_IN2_Pin GPIO_PIN_0
